...
/**
 * Interface to specify that an object is Mortal.
 * A Mortal object has an alive method that returns a boolean, and 
 * a kill method which takes a boolean.
 * Sane Mortal objects will have their alive method respect kill calls,
 * so calling kill(true) should cause a directly subsequent alive to return false.
 */
